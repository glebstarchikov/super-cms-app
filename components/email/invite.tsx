...
export const InviteEmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        {invitedByName} пригласил(а) вас в «{repoName}»
      </Preview>
      <Tailwind>
        <Body
        ...
        >
          <Container className="my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            >
              Присоединиться к «{repoName}» в Plainly
            </Heading>
            <Text
            ...
            >
              ...
              пригласил(а) вас в проект «{repoName}» в Plainly. Перейдите по
              ссылке ниже, чтобы начать совместную работу:
            </Text>
            ...
            >
              ...
              . Если вы считаете, что это ошибка, просто проигнорируйте это
              письмо.
            </Text>
          </Container>
        </Body>
