      ...
      <div className="max-w-screen-sm mx-auto p-4 md:p-6 space-y-8">
        {user.accounts.length > 0 ? (
          <div className="min-h-[calc(100vh-12rem)] flex flex-col justify-center space-y-8">
            ...
            {isGithubUser && templates.some((t) => t.featured) && (
              <div className="space-y-4">
                <h2 className="text-lg font-medium tracking-tight">
                  Создать из шаблона
                </h2>
          ...
          <Empty className="absolute inset-0 border-0 rounded-none">
            <EmptyHeader>
              <EmptyTitle>Установите приложение GitHub</EmptyTitle>
              <EmptyDescription>
                Установите приложение GitHub хотя бы на один аккаунт, чтобы
                открывать проекты.
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
          ...
          <Empty className="absolute inset-0 border-0 rounded-none">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Чтобы редактировать сайт, вас должны пригласить. Попросите
                владельца проекта отправить приглашение.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        )}
